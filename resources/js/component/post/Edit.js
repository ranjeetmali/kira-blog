...
import {requestGetCategoryList, requestGetPost, requestGetPostStatus, requestUpdatePost} from "../../api/api";
...
class Edit extends Component {
    ...
    componentDidMount() {
        ...
        requestGetPost(this.state.id).then(response => {
            ...
            this.setState({
                ...
                featuredImgPreview: post.featured_image_thumb_url,
            });
        }).catch(error => {
            console.log(error);
        });
    ...
    SubmitHandler = (event) => {
        ...
        requestUpdatePost(this.state.id, frmDt).then((response) => {
            this.props.postUpdate(response.data.data);
                                        ...
                                        <div className='col-sm-12'>
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control"
                                                       placeholder="Enter category name" value={this.state.title}
